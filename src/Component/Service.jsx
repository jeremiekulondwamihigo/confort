    ...
    <h4 className="titleProjet">Nos Récent Projets</h4>
      <div className="bodyCard">
        <div className="container">
            ...
            <div className="col-md-4 col-lg-4 col-sm-12">
              <div className="cards">
                ...
                <div className="card-body">
                  <p className="card-info">Salle Polyvalente</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 col-lg-4 col-sm-12">
              <div className="cards">
                ...
                <div className="card-body">
                  <p className="card-info">Maison d'habitation</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 col-lg-4 col-sm-12">
              <div className="cards">
                ...
                <div className="card-body">
                  <p className="card-info">Maison commerciale</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 col-lg-4 col-sm-12">
          ...
          <div className="card-body">
            <p className="card-info">Appartement</p>
          </div>
        </div>
            </div>
            <div className="col-md-4 col-lg-4 col-sm-12">
          ...
          <div className="card-body">
            <p className="card-info">Décoration interne</p>
          </div>
        </div>
            </div>
            <div className="col-md-4 col-lg-4 col-sm-12">
          ...
          <div className="card-body">
            <p className="card-info">Salle Terrase</p>
          </div>
        </div>
            </div>
          </div>
